---
title: "Unveiling the Truth: How Governments Could Be Using Push Alerts as a Surveillance Tool"
date: 2024-10-10T20:03:52.778Z
updated: 2024-10-11T21:38:59.488Z
tags:
  - ios
categories:
  - tech
...
## Unveiling the Truth: How Governments Could Be Using Push Alerts as a Surveillance Tool

###  UPDATE: 2023/12/13 14:23 EST BY CORBIN DAVENPORT

**_Apple updates its policies_** 

 Apple [now requires a judge's warrant order](https://www.reuters.com/technology/apple-now-requires-judges-consent-hand-over-push-notification-data-2023-12-12/) to hand over information about a person's push notifications to law enforcement, according to _Reuters_, instead of handing it over with a simple subpoena. That matches the same policy Google already had in place for Android devices.

 Governments spying on us is nothing new. The governments of some countries are more blatant and invasive than others at doing so, but at this point, it's to be expected that it happens almost everywhere to some degree—even the United States, as the Edward Snowden debacle showed us 10 years ago. Now, a new report indicates governments are monitoring push notifications as an information source.

 In a letter to the Department of Justice, Senator Ron Wyden (D-OR) raised concerns about governments potentially intercepting or otherwise gaining access to push notifications delivered to users' phones. The governments that are implicated in this practice are not laid out in the letter, but the senator said that foreign officials were requesting push notification data from Apple and Google. In a statement to _Reuters_, Apple said that "in this case, the federal government prohibited us from sharing any information," going on to add that "now that this method has become public we are updating our transparency reporting to detail these kinds of requests."
 ...
 Source: [Reuters](https://techcrunch.com/2023/12/06/us-senator-warns-governments-spying-apple-google-smartphone-users-via-push-notifications/), [TechCrunch](https://techcrunch.com/2023/12/06/us-senator-warns-governments-spying-apple-google-smartphone-users-via-push-notifications/), [404 Media](https://www.404media.co/us-government-warrant-monitoring-push-notifications-apple-google-yahoo/)
